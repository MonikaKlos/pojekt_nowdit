...
% Last Modified by GUIDE v2.5 18-Jan-2017 20:44:17
...
for i = 1 : liverLength
   ...
   if(i>=plaszczyzna1 && i<plaszczyzna2)
       segment4(:,:,i) = liver(:,:,i).*maskaPlaszczyzna1;
       segment5(:,:,i) = liver(:,:,i).*maskaPlaszczyzna2;
       segment6(:,:,i) = liver(:,:,i).*maskaPlaszczyzna3;
   else
...
daspect([1,1,zscale])
axis on
set(handles.axes_segment,'color',[1,1,1]*.8)
set(handles.axes_segment,'xlim',[0 250], 'ylim',[0 250])
